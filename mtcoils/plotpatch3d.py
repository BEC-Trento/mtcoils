...
def cycle_kwargs(**kwargs):
    # I need to broadcast, not to multiply!
    keys, values = zip(*kwargs.items())
    values = np.broadcast_arrays(*values)
    kw1 = {k: v for k, v in zip(keys, values)}
    return cycler(**kw1)
...
def pathpatch_2d_to_3d(pathpatch, z=0, normal='z', translate=None):
    """
